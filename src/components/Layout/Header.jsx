...
//             >
//               {pages.map((page) => (
//                 <MenuItem key={page.name} component={Link} onClick={handleCloseNavMenu}>
...
function Header() {
  ...
  const handleNavigate = (path) => {
    navigate(path); // Aquí navegamos usando useNavigate
    handleCloseNavMenu(); // Cerrar el menú al hacer clic
  };
